...
<div class="training-info coaching-info">
  <div class="text d-flex">
    ...
    <div class="right-text">
      ...
      <div class="action-button"><a href="/our-counsellors?type=Life+coach&therapy=&coaching=&common="><?php the_field('lc_righttext_button'); ?></a></div>
    </div>
  </div>
  ...
  <div class="reasons">
    <div class="reasons-content">
      ...
      <div class="action-button ot-action-button">
        <a href="/our-counsellors?type=Life+coach&therapy=&coaching=&common="><?php the_field('lc_r_button'); ?></a>
      </div>
    </div>
  </div>
